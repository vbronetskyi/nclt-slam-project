...
# pathsRESULTS = Path('/workspace/datasets/nclt/results/week0_hloc/full')
...
# count resultsn_loc = sum(1 for line in open(loc_results) if line.strip() and not line.startswith('#'))
