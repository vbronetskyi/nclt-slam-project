...
# load scansscans, timestamps = load_velodyne_scans(SESSION, subsample=SUBSAMPLE)
...
# get trajectorycustom_traj = odometry.get_trajectory()
print(f"Trajectory: {len(custom_traj)} poses")

# synchronize with ground truthprint("\n" + "="*80)
...
# translation errortime_rpe = time_axis[:-1]  # RPE has n-1 values
...
# rotation errorax2.plot(time_rpe, rpe['rot_errors'], 'r-', linewidth=1, alpha=0.7)
