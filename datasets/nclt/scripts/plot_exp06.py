...
fig.suptitle('Experiment 0.6: DEFINITIVE ORB-SLAM3 EVALUATION — Full Results\n'
...
# add stereo rowsfor r in phase_c_runs:
    cfg = r.get('config', {})
    rows.append([
        r['label'],
        'Stereo+IMU',
...
# last panel: Plan completion statusax = axes[1, 2]
ax.axis('off')
