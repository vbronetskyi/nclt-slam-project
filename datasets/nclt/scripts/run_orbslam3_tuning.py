#!/usr/bin/env python3
"""
ORB-SLAM3 Systematic Parameter Tuning on NCLT Ladybug3
=======================================================
Designed to run unattended overnight.

Phases:
  0. Camera investigation - find best side cameras
  1. Quick validation on 1000 frames
  2. Systematic parameter sweep on 3000 frames
  3. Full session run with best config
  4. Save results, plots, commit

Usage:
    python scripts/run_orbslam3_tuning.py
"""
