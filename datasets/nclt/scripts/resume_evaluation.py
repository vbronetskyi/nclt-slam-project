...
# re-generate image lists and GT posesspring_every, summer_every = 3, 5
...
# load SfM modelmodel = pycolmap.Reconstruction(str(outputs / 'sfm'))
...
# parse localization resultsloc_results_file = outputs / 'localization_results.txt'
loc_poses = {}
