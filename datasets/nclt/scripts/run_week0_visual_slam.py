#!/usr/bin/env python3
"""
Week 0: Visual SLAM Baseline on NCLT
=====================================
Runs visual odom/SLAM on Ladybug3 across sessions vs ground truth

1. Try ORB-SLAM3 mono (if available)
2. Fallback: OpenCV VO (ORB + essential matrix)

With images: 2012-04-29 (spring), 2012-08-04 (summer)
LiDAR only: 2012-01-08 (winter), 2012-10-28 (autumn)
"""
import os
import sys
import numpy as np
