#!/usr/bin/env python3
"""
Week 0: ORB-SLAM3 on NCLT Ladybug3 Camera Images
==================================================
Prepares NCLT camera images in TUM format and runs ORB-SLAM3 monocular mode.
Only works on sessions with images: 2012-04-29 (spring), 2012-08-04 (summer).
"""
import os
import sys
import subprocess
