...
ORB-SLAM3 monocular is NOT viable for NCLT Ladybug3. No parameter configuration achieved reliable tracking on the spring session. The combination of 5 Hz fisheye camera, unmodeled distortion, and lack of IMU fusion creates conditions that feature-based monocular SLAM cannot overcome thorugh parameter tuning alone.
