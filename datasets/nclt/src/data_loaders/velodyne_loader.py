"""
Velodyne HDL-32E point cloud loader for NCLT

Binary format (8 bytes/point): x,y,z as uint16, intensity, laser_id
Raw coords: actual = raw * 0.005 - 100.0
...
class VelodyneLoader:
    """loader for Velodyne HDL-32E point clouds"""

    SCALING = 0.005  # 5mm per unit
    OFFSET = -100.0
    BYTES_PER_POINT = 7  # Actually 8 with padding
