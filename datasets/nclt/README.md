...
```
   ...
   Cam0 = TOP (sky-facing, not useful for SLAM)
```
...
![All trajectories across 4 seasons](results/summary_plots/fig1_all_trajectories.png)
...
4. **Deep visual SLAM (DROID-SLAM, DPVO) fails similarly** -- produces trajectories that don't follow road geometry. The fundamental bottleneck is sensor hardware, not algorithm quality.
...
- NVIDIA RTX 5080 16GB, CUDA 12.8, PyTorch 2.10
