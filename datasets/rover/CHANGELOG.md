# ROVER - experiment log

## Overview

ORB-SLAM3 baseline evaluation on the ROVER dataset (Esslingen University,
HuggingFace iis-esslingen/ROVER) - multi-season ground robot recordings
with T265 stereo fisheye + IMU and D435i RGB-D.  see also the
[robotcar](../robotcar/CHANGELOG.md) and [4seasons](../4seasons/CHANGELOG.md)
changelogs for the earlier experiments that motivated this one.
...
6. **Scale factors are consistently near 1.0** for succesful RGB-D runs (0.93–1.04), confirming correct depth integration.
...
- Plots: `results/comparison_bar_final.png`, `results/comparison_heatmap_final.png`
