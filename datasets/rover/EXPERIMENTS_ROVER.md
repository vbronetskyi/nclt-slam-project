...
3 out of 5 "successful" campus_large runs actually crashed with SIGSEGV, but **after** saving the trajectory. The difference between "success" and "failure" is merely the timing of the crash relative to file writing.
...
- BAD LOOP threshold (0.008 rad — relaxation worsens results)
