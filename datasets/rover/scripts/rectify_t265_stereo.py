...
T265 has ~170deg FoV equidistant fisheye, KB8 stereo matching fails outdoors
undistorts each camera to pinhole (default 110deg HFoV) so ORB-SLAM3 can
use PinHole stereo mode
...
def make_pinhole_matrix(hfov_deg, width, height):
    """create pinhole camera matrix for a given hFoV
