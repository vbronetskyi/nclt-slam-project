...
Training is done on Kaggle GPU using the preprocessed [NCLT hackathon dataset](https://www.kaggle.com/datasets/creatorofuniverses/nclt-iprofi-hack-23) (10 sessions, Jan--Dec 2012). A separate [sensors addon dataset](https://www.kaggle.com/datasets/) provides IMU, GPS, odometry, and ground truth for multi-sensor fusion experiments.
...
**Sensors addon** (optional, for IMU/GPS/odometry experiments): attach the `nclt-sensors-addon` dataset on Kaggle or download locally to `data/nclt_sensors_addon/`.
