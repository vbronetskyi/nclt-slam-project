...
| 1.1 | ORB-SLAM3 (3 modes) | ROVER (15 recordings) | 0.45 m median (RGB-D) | 73.3% | T265 stereo fails; D435i RGB-D works |
...
- **Results:** `results/rover/summary.txt`, `results/rover/all_results.json`
- **Plots:** `results/rover/comparison_bar.png`, `results/rover/comparison_heatmap.png`, `results/rover/comparison_garden_vs_park.png`
- **Per-recording:** `results/rover/{recording}/{mode}/eval_results.json`, `trajectory_comparison.png`, `orbslam3_log.txt`
