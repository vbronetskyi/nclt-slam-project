#!/usr/bin/env python3
"""
Re-run fixed methods + new ALIKED+OpenIBL combination.
...
Usage:
  tmux new -s hloc_fix
  python3 /workspace/datasets/robotcar/scripts/run_fixes_and_new.py 2>&1 | tee /workspace/robotcar_hloc_fix_log.txt
"""
