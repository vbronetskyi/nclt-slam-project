"""Visualization utilities for SLAM evaluation.

Provides trajectory plotting, point cloud visualization,
and metric visualization functions.
"""
...
def plot_trajectory_2d(
    ...
    Args:
        trajectories: Dict mapping label to (N, 4, 4) pose arrays.
...
def plot_error_over_time(
    ...
    Args:
        errors: (N,) array of per-frame errors.
...
def plot_recall_at_k(
    ...
    Args:
        recall_values: Dict mapping "recall@K" to value (0-1).
        output_path: Optional path to save figure.
        title: Plot title.
...
def plot_loop_closures_on_map(
    ...
    Args:
        ...
        loop_pairs: List of (source_idx, target_idx) pairs.
        output_path: Optional path to save figure.
        title: Plot title.
