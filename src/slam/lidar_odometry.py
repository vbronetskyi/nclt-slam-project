"""LiDAR odometry using point cloud registration.

Implements frame-to-frame and frame-to-keyframe registration
using ICP variants from Open3D.
"""
...
class OdometryConfig:
    ...
    Attributes:
        method: Registration method ("icp", "gicp", "ndt").
        max_iterations: Maximum ICP iterations.
        convergence_threshold: Convergence criterion (RMSE change).
        max_correspondence_distance: Maximum point correspondence distance.
        voxel_size: Voxel downsampling size before registration.
        keyframe_distance: Translation threshold for new keyframe.
        keyframe_rotation: Rotation threshold for new keyframe (degrees).
    """
...
class OdometryResult:
    ...
    Attributes:
        poses: List of 4x4 SE3 poses in world frame.
...
class LiDARodometry:
    ...
    def process_frame(
        ...
        Returns:
            Estimated 4x4 SE3 pose in world frame.
        """
    ...
    def _preprocess(self, points: np.ndarray) -> o3d.geometry.PointCloud:
        ...
        Args:
            points: Raw point cloud (N, 3) or (N, 4).

        Returns:
            Downsampled Open3D point cloud with normals.
        """
    ...
    def _register(
        ...
        Args:
            source: Source (current frame) point cloud.
            target: Target (previous frame) point cloud.
    ...
    def _is_keyframe(self) -> bool:
        ...
        Returns:
            True if distance or rotation from last keyframe exceeds threshold.
        """
    ...
    def get_result(self) -> OdometryResult:
        """Get accumulated odometry result.

        Returns:
            OdometryResult with all poses and keyframe info.
        """
        return self._result

    def get_trajectory(self) -> np.ndarray:
        """Get trajectory as array of poses.
