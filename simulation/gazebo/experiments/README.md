...
1. **00_navigation_test** - Validated the full Nav2 stack (SLAM Toolbox + RPP controller) on a small area. Identified and fixed key issues with costmap memory growth and controller compatibility for skid-steer drive. Documented fixes in the [fixes/](fixes/) directory.
