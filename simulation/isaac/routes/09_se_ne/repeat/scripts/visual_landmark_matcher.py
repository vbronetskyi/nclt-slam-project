...
Tuning history: took a few weeks to get right. early versions had the
consistency check too loose (10 m gate) so PnP outliers kept getting
promoted to anchors and the robot would teleport. 3 m gate (CONSISTENCY_M)
