...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/04_nw_se/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/04_nw_se/teach/teach_outputs/teach_map.yaml"
