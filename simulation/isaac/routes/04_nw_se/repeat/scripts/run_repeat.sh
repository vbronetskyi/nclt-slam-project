...
E72=/workspace/simulation/isaac/routes/04_nw_se/repeat
SCRIPTS=/workspace/simulation/isaac/scripts
SLAM=/workspace/third_party/ORB_SLAM3
DOMAIN=${ROS_DOMAIN_ID:-85}

TEACH=/root/isaac_tr_datasets/04_nw_se/teach/teach_outputs
