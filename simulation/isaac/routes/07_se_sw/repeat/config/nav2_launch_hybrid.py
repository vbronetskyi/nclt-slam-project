...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/07_se_sw/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/07_se_sw/teach/teach_outputs/teach_map.yaml"
