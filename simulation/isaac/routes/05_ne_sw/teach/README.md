...
*[thesis root](../../../../../README.md) > [simulation](../../../../README.md) > isaac > routes > 05_ne_sw > teach*


Corner-to-corner roundtrip teach: **diagonal RT->LB**
...
- total waypoints: **510** (255 outbound + turnaround arc + mirrored return)
- total path length (incl. return): **407.2 m**
- spawn: x=+65.00, y=+35.00, yaw=-2.620 rad (-150°)
...
1. `register_routes.py` merges `_common/routes_04_07.json` into
   ...
   `--route 05_ne_sw` as a predefined path.
2. Isaac Sim launches with:
   `--synthetic-imu --route 05_ne_sw --duration 4500`
...
## Outputs (teach/05_ne_sw/ after a successful run)
