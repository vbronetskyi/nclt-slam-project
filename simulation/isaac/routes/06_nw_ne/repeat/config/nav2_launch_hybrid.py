...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/06_nw_ne/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/06_nw_ne/teach/teach_outputs/teach_map.yaml"
