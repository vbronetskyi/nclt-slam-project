...
*[thesis root](../../../../../README.md) > [simulation](../../../../README.md) > isaac > routes > 06_nw_ne > teach*


Corner-to-corner roundtrip teach: top edge LT->RT
...
- total waypoints: 493 (246 outbound + turnaround arc + mirrored return)
- total path length (incl. return): **394.2 m**
- spawn: x=-90.00, y=+35.00, yaw=+0.024 rad (+1°)
...
1. `register_routes.py` merges `_common/routes_04_07.json` into
   ...
   `--route 06_nw_ne` as a predefined path.
2. Isaac Sim launches with:
   `--synthetic-imu --route 06_nw_ne --duration 4500`
...
## Outputs (teach/06_nw_ne/ after a successful run)
