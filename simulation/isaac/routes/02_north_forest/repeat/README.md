...
*[thesis root](../../../../../README.md) > [simulation](../../../../README.md) > isaac > routes > 02_north_forest > repeat*
...
- visual_landmark_matcher - матчить ORB поточного кадру з teach `landmarks.pkl`,
...
- send_goals_hybrid - зчитує teach vio_pose_dense.csv (gt_x,gt_y), робить
