...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/02_north_forest/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/02_north_forest/teach/teach_outputs/teach_map.yaml"
