...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/01_road/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/01_road/teach/teach_outputs/teach_map.yaml"
