#!/usr/bin/env python3
"""teach-time depth map snapshotter

during teach, accumulates the depth pointcloud from /camera/depth/image_rect_raw
into a persistent occupancy-like YAML that repeat runs can load as a prior

why: helps the repeat-time Nav2 costmap start with a reasonable static layer
