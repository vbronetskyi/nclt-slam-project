...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/62_tight_detour_anchor_sanity/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/62_tight_detour_anchor_sanity/teach/south_teach_map.yaml"
