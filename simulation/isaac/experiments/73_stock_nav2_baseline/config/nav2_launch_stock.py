...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/73_stock_nav2_baseline/config/nav2_stock_params.yaml"
    map_yaml = "/root/isaac_tr_datasets/09_se_ne/teach/teach_outputs/teach_map.yaml"
