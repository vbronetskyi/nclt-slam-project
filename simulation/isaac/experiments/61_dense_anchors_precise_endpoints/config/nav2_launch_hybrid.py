...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/61_dense_anchors_precise_endpoints/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/61_dense_anchors_precise_endpoints/teach/south_teach_map.yaml"
