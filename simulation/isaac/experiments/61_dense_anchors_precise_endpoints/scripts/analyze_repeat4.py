...
REPEAT_DIR = '/workspace/simulation/isaac/experiments/52_obstacles_v9/results/repeat_run4'
...
def main():
    ...
    plot_trajectory_map(
        ...
        output=OUT_PNG,
        title='Exp 52 v9 - Repeat run 4 (tent on route, 2/3/4 cones) - SLAM lost near tent',
