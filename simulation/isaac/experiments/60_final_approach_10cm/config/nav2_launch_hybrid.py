...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/60_final_approach_10cm/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/60_final_approach_10cm/teach/south_teach_map.yaml"
