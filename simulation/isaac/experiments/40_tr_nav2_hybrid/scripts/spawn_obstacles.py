...
OBSTACLES = {
    "road": {
        "cones": [
            # x=-50: route y≈-4.8. Cones 2m apart -> 1.4m gap (passable but costly)
            # Bypass north (y>-2): clear road. Nav2 should prefer going around.
            [(-50, -6.0), (-50, -4.0), (-50, -2.0)],
            # x=15: route y≈-2.0. Cones 2m apart.
            # Bypass south (y<-5): clear road.
            [(15, -3.5), (15, -1.5), (15, 0.5)],
            # x=45: route y≈-1.2. Cones 2m apart.
            # Bypass south (y<-3): clear road
            [(45, -2.5), (45, -0.5), (45, 1.5)],
        ],
        "tent": (-20, 0.0),
    },
    "north": {
