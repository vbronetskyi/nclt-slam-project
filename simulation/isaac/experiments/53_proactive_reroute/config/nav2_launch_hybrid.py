...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/53_proactive_reroute/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/53_proactive_reroute/teach/south_teach_map.yaml"
