...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/58_route_sanitize_accum/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/58_route_sanitize_accum/teach/south_teach_map.yaml"
