...
parser.add_argument("--route", type=str, default=None,
                    choices=["road", "north", "south", "road_nav2", "warmup", "north_forest"],
                    help="predefined route: road (S-curve), north (forest), south (forest), warmup (straight), north_forest (deep N-forest teach, exp 71)")
