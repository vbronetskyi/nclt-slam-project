...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/72_repeat_north_forest_accel_noise/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/71_teach_north_forest_accel_noise/teach/north_forest/teach_map.yaml"
