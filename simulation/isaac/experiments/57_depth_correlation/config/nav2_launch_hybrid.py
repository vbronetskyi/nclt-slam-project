...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/57_depth_correlation/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/57_depth_correlation/teach/south_teach_map.yaml"
