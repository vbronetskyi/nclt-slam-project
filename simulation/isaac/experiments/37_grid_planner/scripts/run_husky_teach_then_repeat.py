...
_exp_dir = ("37_grid_planner" if args.use_planner
...
if args.use_planner:
    ...
    grid_planner = GridPlanner(grid_size=100, resolution=0.2)
    print("  GridPlanner (A*) enabled")
            ...
            if depth_raw is not None:
                ...
                if grid_planner is not None:
                    ...
                    if path_ok:
                        ...
                        # Speed: scale with heading error
                        herr_abs = abs(plan_herr)
                        if herr_abs < 0.5:
                            last_nav_lin = 0.55 * (1.0 - 0.5 * herr_abs / 0.5)
                        else:
                            last_nav_lin = 0.15
                        last_nav_mode = "PLAN"
                    else:
                    ...
                    last_nav_debug = {
                        ...
                        "impassable": pdi["impassable"],
                        "inflated": pdi["inflated"],
                        "blocked_ratio": 0,
