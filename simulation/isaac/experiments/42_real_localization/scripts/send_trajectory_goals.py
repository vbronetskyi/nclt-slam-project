...
class TrajectoryFollower(Node):
    def __init__(self, waypoints_file, direction="outbound"):
        ...
        self.GOAL_TIMEOUT = 20.0 if direction == "return" else 15.0
...
def main():
    ...
    rclpy.init()
    follower = TrajectoryFollower(args.anchors, direction=args.direction)
