...
#
# Produces:
#   results/run_09/{isaac,vio,tf_slam,nav2,pp_follower,supervisor,plan_logger,
#                       landmark_matcher,goals,anchor_matches.csv}.log
set -eu

E52=/workspace/simulation/isaac/experiments/52_obstacles_v9
E66=/workspace/simulation/isaac/routes/09_se_ne/teach
E72=/workspace/simulation/isaac/routes/09_se_ne/repeat
SCRIPTS=/workspace/simulation/isaac/scripts
SLAM=/workspace/third_party/ORB_SLAM3
DOMAIN=${ROS_DOMAIN_ID:-89}

TEACH=/root/isaac_tr_datasets/09_se_ne/teach/teach_outputs
OUT=${RGBD_OUT_DIR:-/workspace/simulation/isaac/experiments/76_rgbd_no_imu_ours/results/run_09}
mkdir -p $OUT/plans
...
setsid ./Examples/RGB-D/rgbd_live \
    Vocabulary/ORBvoc.txt /workspace/simulation/isaac/experiments/76_rgbd_no_imu_ours/config/rgbd_th160.yaml $REC \
