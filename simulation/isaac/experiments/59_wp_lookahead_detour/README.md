...
*[thesis root](../../../../README.md) > [simulation](../../../README.md) > isaac > experiments > 59_wp_lookahead_detour*
...
The last row was a bug in goal_sender accross exps 55–58: it used GT to test
...
to reach WPs that lie within 0.9 m of any known obstacle. A WP that was
"reached" in exp 56 (robot drove 0.5 m past a cone) is a SKIP in exp 59.
