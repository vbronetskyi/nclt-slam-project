...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/59_wp_lookahead_detour/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/59_wp_lookahead_detour/teach/south_teach_map.yaml"
