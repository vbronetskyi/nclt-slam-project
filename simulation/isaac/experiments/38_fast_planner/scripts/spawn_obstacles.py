...
OBSTACLES = {
    "road": {
        "cones": [
            # x=-50: route y≈-4.8. Cones at y=-5.5,-4.5,-3.5 block route.
            # Bypass north (y>-3): 2.2m road left. Robot must go y>-3.2
            [(-50, -5.5), (-50, -4.5), (-50, -3.5)],
            # x=15: route y≈-2.0. Cones at y=-3,-2,-1 block route.
            # Bypass south (y<-3.5): 2.5m road left. Robot must go y<-3.5
            [(15, -3.0), (15, -2.0), (15, -1.0)],
            # x=45: route y≈-1.2. Cones at y=-2,-1,0 block route.
            # Bypass south (y<-2.5): 2.7m road left.
            [(45, -2.0), (45, -1.0), (45, 0.0)],
        ],
        "tent": (-20, 0.0),
    },
    "north": {
