...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/69_repeat_road_split_landmarks_accel_noise/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/66_teach_road_with_accel_noise/teach/road/teach_map.yaml"
