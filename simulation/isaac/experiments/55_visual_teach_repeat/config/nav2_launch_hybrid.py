...
def generate_launch_description():
    config = "/workspace/simulation/isaac/experiments/55_visual_teach_repeat/config/nav2_planner_only.yaml"
    map_yaml = "/workspace/simulation/isaac/experiments/55_visual_teach_repeat/teach/south_teach_map.yaml"
