...
class TestMetrics:
    """Tests for SLAM evaluation metrics."""

    def test_compute_ate_identical(self):
        """ATE should be zero for identical trajectories."""
    ...
    def test_compute_ate_with_offset(self):
        """ATE should detect constant offset after alignment."""
        from src.evaluation.metrics import compute_ate
        ...
        # After Umeyama alignment, the constant offset should be removed
        assert ate["rmse"] < 0.1

    def test_compute_rpe_identical(self):
        """RPE should be zero for identical trajectories."""
    ...
    def test_recall_at_k_perfect(self):
        """Recall@1 should be 1.0 when queries match themselves."""
    ...
    def test_recall_at_k_no_matches(self):
        """Recall should be 0 when no query has a true positive in DB."""
        from src.evaluation.metrics import recall_at_k
    ...
    def test_precision_recall_curve(self):
        ...
        # At the highest threshold, only the most similar pair is retrieved
        assert prec[0] == 1.0  # first true positive is correct

    def test_pose_error(self):
        """Test single pose error computation."""
...
class TestTransforms:
    ...
    def test_random_rotation_shape(self):
        """Rotation should preserve point count and dimensions."""
    ...
    def test_random_subsample(self):
        """Subsampling should reduce to target count."""
    ...
    def test_random_subsample_small_input(self):
        """Subsampling should not expand smaller clouds."""
        from src.datasets.transforms import RandomSubsample
    ...
    def test_voxel_downsample(self):
        """Voxel downsample should reduce point count."""
    ...
    def test_remove_ground(self):
        """Ground removal should filter low points."""
    ...
    def test_compose(self):
        """Composed transforms should apply sequentially."""
    ...
    def test_jitter_changes_values(self):
        """Jitter should modify point positions."""
        ...
        # Intensity (4th column) should be unchanged
