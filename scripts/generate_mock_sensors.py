...
University of Michigan North Campus. All files are written to the
nclt_mock/2012-01-08/ directory under the project data root.
...
def generate_mock_sensors(output_dir: str) -> None:
    """Generate all mock sensor CSV files.
